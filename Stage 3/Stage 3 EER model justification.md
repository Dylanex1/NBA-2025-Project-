...
* The has relationship is one-to-one since each coach will have at most one game record in the dataset. This is because all NBA games they have coached are in this one record of all time wins, losses and games played. A game record has 1 coach that it is tied to since we do not keep track of a record for multiple coaches that would logically not make any sense. 
