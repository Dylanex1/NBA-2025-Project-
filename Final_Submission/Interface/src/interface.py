...
class Interface:
    ...
    COMPLEX_CMDS = [
        ...
        "q10 <min_attempts> <N>", "q11 <game_id>", "q12 \"<team1_name>\" \"<team2_name>\"",
    ...
    COMPLEX_DESCS = [
        ...
        "Shows the win percentage of \"<team1_name>\" against \"<team2_name>\"",
    ...
    def __init__(self):
        ...
        self.CMDS = {
            ...
            "q12" : {"argc" : 2, "run" : self._database_manager.run_q12, "usage" : "q12 \"<team1_name>\" \"<team2_name>\""},
